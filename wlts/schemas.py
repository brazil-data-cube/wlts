...
list_classification_system_response = load_schema('list_classification_sytem_response.json')
describe_classification_system = load_schema('describe_classification_sytem_request.json')
describe_classification_system_response = load_schema('describe_classification_sytem_response.json')
